...
MAHJONG_IMAGES+=["./material/tupai/p_ji_e_1.png","./material/tupai/p_ji_s_1.png","./material/tupai/p_ji_w_1.png","./material/tupai/p_ji_n_1.png"
                ,"./material/tupai/p_no_1.png","./material/tupai/p_ji_h_1.png","./material/tupai/p_ji_c_1.png"
                ,"./material/manzu/p_msaka.png","./material/pinzu/pinaka.png","./material/sozu/soaka.png","./material/tupai/ura.png"]
...
def draw_points(field_points,player_points,size=(2160,3840,3),img=None,reduction=1):
    ...
    for i in range(4):
        ...
        if i == 0:
            ...
            pt1 = [draw_points[0][0]+hai_size,draw_points[0][1]+hai_size]
        elif i == 3:
            pt1 = [draw_points[1][0]-hai_size-add_img.shape[1],draw_points[0][1]+hai_size]
        elif i == 2:
            add_img=cv2.rotate(add_img, cv2.ROTATE_90_CLOCKWISE)
            pt1 = [draw_points[1][0]-hai_size-add_img.shape[1],draw_points[1][1]-hai_size-add_img.shape[0]]
        elif i == 1:
            add_img=cv2.rotate(add_img, cv2.ROTATE_90_COUNTERCLOCKWISE)
            pt1 = [draw_points[0][0]+hai_size,draw_points[1][1]-hai_size-add_img.shape[0]]
...
def draw_kaze(field_points,player,size=(2160,3840,3),img=None,reduction=1):
    ...
    kaze_img=kaze_img[5-player:]+kaze_img[:5-player]
